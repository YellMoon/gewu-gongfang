...
ipcMain.handle('desktop-identity:begin-unified-online-recovery', (_event, input) => getDesktopIdentityVault().beginUnifiedOnlineRecovery(input));
ipcMain.handle('desktop-identity:complete-registration', (_event, input) => getDesktopIdentityVault().completeRegistration(input));
ipcMain.handle('desktop-identity:complete-unified-online-recovery', (_event, input) => getDesktopIdentityVault().completeUnifiedOnlineRecovery(input));
