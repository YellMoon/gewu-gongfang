...
assert.match(plan.sql, /GRANT CREATE ON DATABASE "gewu_cloud_shadow_20260823" TO vnext_pg17_business_owner/);
assert.match(plan.sql, /REVOKE CREATE ON DATABASE "gewu_cloud_shadow_20260823" FROM vnext_pg17_business_owner/);
