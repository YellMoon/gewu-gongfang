...
assert.match(result.sql, /GRANT CONNECT ON DATABASE gewu_cloud TO vnext_pg17_identity_verifier, vnext_pg17_writer/);
assert.match(result.sql, /GRANT USAGE ON SCHEMA vnext_control_plane TO vnext_pg17_writer/);
