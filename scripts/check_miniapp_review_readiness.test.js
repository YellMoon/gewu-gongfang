...
assert.ok(info.testRemark.includes('微信手机号'));
assert.ok(info.versionDesc.includes('首次登录'));
assert.ok(info.versionDesc.includes('访客'));
assert.ok(info.versionDesc.includes('家庭成员'));
assert.ok(info.testRemark.includes('已绑定微信直接登录'));
assert.ok(!info.versionDesc.includes('手填手机号'));
assert.ok(!info.testRemark.includes('手填手机号'));
assert.ok(!info.testRemark.includes('前十道脱敏题目'));
