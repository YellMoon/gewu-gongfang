...
assert.ok(info.versionDesc.includes('游客'));
assert.ok(info.testRemark.includes('手填'));
assert.ok(!info.versionDesc.includes('授权审核员本人的微信手机号'));
assert.ok(!info.testRemark.includes('授权审核员本人的微信手机号'));
