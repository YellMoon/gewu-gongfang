...
assert.doesNotMatch(sql, /GRANT ALL|INSERT ON TABLE business\.storage_task_receipts|DELETE ON TABLE business\.storage_object_tasks|UPDATE ON TABLE business\.storage_task_receipts|DELETE ON TABLE business\.storage_task_receipts/iu);
