-- UTF-8: course updates must not write linked lessons ahead of their explicit draft confirmation.
BEGIN;
...
BEGIN
  ...
  -- The existing desktop full-course address linkage stages lesson drafts. Only
  -- vnext_update_scoped_schedule may submit them with their own version baseline.
