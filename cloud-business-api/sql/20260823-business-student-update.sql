...
CREATE OR REPLACE FUNCTION business.vnext_update_student(
  p_tenant_id text,
  p_student_id text,
...
REVOKE ALL ON FUNCTION business.vnext_update_student(text,text,timestamptz,text,text,integer,text,text,text,text) FROM PUBLIC;
GRANT USAGE ON SCHEMA business TO vnext_pg17_writer;
GRANT EXECUTE ON FUNCTION business.vnext_update_student(text,text,timestamptz,text,text,integer,text,text,text,text) TO vnext_pg17_writer;
