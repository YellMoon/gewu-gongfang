...
async function main() {
  ...
  assert.deepStrictEqual(
    await service.reportRuntime({ agentId: 'storage-agent-1', token: 'storage-agent-test-token-with-sufficient-length', agentVersion: '8.8.0', contracts: { questionPaperExport: 3, storageAgentTransport: 2 } }),
    { receiptId: 'storage_runtime_receipt_12345678', agentId: 'storage-agent-1', agentVersion: '8.8.0', contracts: { questionPaperExport: 3, storageAgentTransport: 2 } },
  );
  assert.deepStrictEqual(
  ...
  assert.deepStrictEqual(calls, [
    ...
    ['runtime', { agentId: 'storage-agent-1', agentVersion: '8.8.0', contracts: { questionPaperExport: 3, storageAgentTransport: 2 } }],
  ...
  await assert.rejects(
    () => service.reportRuntime({ agentId: 'storage-agent-1', token: 'wrong-token', agentVersion: '8.8.0', contracts: { questionPaperExport: 3, storageAgentTransport: 2 } }),
