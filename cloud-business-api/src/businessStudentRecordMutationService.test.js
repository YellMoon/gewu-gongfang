...
(async () => {
  ...
  const contacts = [{ slot: 1, relationship: 'student', phone: '13800138000', wechat: null, expectedUpdatedAt: '2026-08-22T00:00:00.000Z' }];
  ...
  assert.match(calls[0][0], /business\.vnext_update_student_record_v3/);
