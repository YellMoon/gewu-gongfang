...
def _document(
    ...
    return FormulaDocument(
        ...
        source=FormulaSource(
            ...
            table_row=row.tokens[content_index].source.table_row if content_index < len(row.tokens) else None,
            table_cell=row.tokens[content_index].source.table_cell if content_index < len(row.tokens) else None,
            cell_paragraph=row.tokens[content_index].source.cell_paragraph if content_index < len(row.tokens) else None,
