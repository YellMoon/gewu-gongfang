...
assert.deepStrictEqual(
  cloudSessionUser({ accountId: 'student-1', status: 'active', roles: ['student'], profile: { type: 'student', id: 'student-profile-1', relationship: 'student' } }),
...
assert.deepStrictEqual(
  cloudSessionUser({ accountId: 'guardian-1', status: 'active', roles: ['family_member'], profile: { type: 'student', id: 'student-profile-1', relationship: 'guardian' } }),
  { id: 'guardian-1', cloud_account_id: 'guardian-1', role: 'family_member', user_type: 'family_member', identity_kind: 'family_member', student_relationship: 'guardian', account_state: 'formal', token_use: 'miniapp-cloud', student_id: 'student-profile-1', linked_student_ids: ['student-profile-1'] },
);
