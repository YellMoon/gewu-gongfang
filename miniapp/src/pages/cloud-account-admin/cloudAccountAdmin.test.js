...
assert.ok(page.includes('miniappCloudBusinessApi.assignAccountRole(token, accountId, role)'), 'the page must authorize only through the cloud account boundary');
