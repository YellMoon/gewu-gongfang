...
const STATE_COPY = Object.freeze({
  ...
  not_submitted: ['申请老师或学生角色', '申请将作为权威命令交由数据主机超级管理员审核。'],
  invalid: ['申请内容需要调整', '只能申请老师或学生角色，请核对后重试。'],
  submitting: ['正在提交权威命令', '请勿重复操作。'],
  submitted: ['等待数据主机审核', '申请已经进入持久命令队列，断线后仍会继续处理。'],
  rejected: ['角色申请已拒绝', '如需重新申请，请联系数据主机管理员确认原因。'],
  approved: ['角色申请已批准', '重新登录后将读取数据主机签名的最新角色投影。'],
