...
assert.throws(() => policy.canonicalizeEffectiveScopes([{ scopeType: 'school', scopeValueHash: 'A'.repeat(64), effect: 'allow', status: 'active', startsAt: '2026-08-13T00:00:00.000Z' }], '2026-08-14T00:00:00.000Z'), /VNEXT_POLICY_INVALID/);
