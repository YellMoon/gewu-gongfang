...
async function runCanonicalWechatContactBindingCases(runtime) {
  ...
  try {
    ...
    assert.deepStrictEqual(await readVNextPg17CanonicalAccountByVerifiedContact(activeRuntime, handle, { contactType: 'wechat_openid', contactHash: hash('a') }), { authorityId: 'authority-1', accountId: 'account-1' });
