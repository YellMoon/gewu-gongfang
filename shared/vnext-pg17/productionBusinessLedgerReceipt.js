...
const CLOUD_QUESTION_AUTHORITY_SQL_PATH = path.resolve(
  __dirname,
  '..',
  '..',
  'cloud-business-api',
...
const EXPECTED_CLOUD_QUESTION_AUTHORITY_MANIFEST_SHA256 = '49d06c0e914f6de8803082922702992b1b57970696f190718b0bd9ab98ff0d11';
const CLOUD_QUESTION_AUTHORITY_SQL = fs.readFileSync(CLOUD_QUESTION_AUTHORITY_SQL_PATH, 'utf8');
...
if (sha256(CLOUD_QUESTION_AUTHORITY_SQL.trim()) !== EXPECTED_CLOUD_QUESTION_AUTHORITY_MANIFEST_SHA256) {
  throw new Error('PRODUCTION_BUSINESS_LEDGER_RECEIPT_SOURCE_HASH_MISMATCH');
}
...
const CLOUD_QUESTION_AUTHORITY_MIGRATION = Object.freeze({
  migrationId: 'business-cloud-question-authority-5',
  semanticVersion: 5,
  sql: CLOUD_QUESTION_AUTHORITY_SQL,
  manifestSha256: EXPECTED_CLOUD_QUESTION_AUTHORITY_MANIFEST_SHA256,
});
...
const PRODUCTION_BUSINESS_LEDGER_MIGRATIONS = Object.freeze([
  ...
  CLOUD_QUESTION_AUTHORITY_MIGRATION,
]);
...
module.exports = {
  ...
  EXPECTED_CLOUD_QUESTION_AUTHORITY_MANIFEST_SHA256,
  CLOUD_QUESTION_AUTHORITY_MIGRATION,
  CLOUD_QUESTION_AUTHORITY_SQL_PATH,
