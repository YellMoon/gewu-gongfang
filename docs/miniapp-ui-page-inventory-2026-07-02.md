...
| --- | --- | --- | --- | --- |
| `pages/login/index` | guest | 登录/邀请码 | 品牌化登录、输入和按钮状态 | 登录、邀请码、loading |
...
| `pages/admin/invitations/index` | admin | 邀请管理 | 邀请码列表、创建表单、状态 | 列表、创建、空态 |
...
- 管理员路径至少覆盖：首页、课程表、学生、课程、教师、缴费、统计、题库、资产、设置、用户权限、邀请、无权限。
