...
| account-application/index | V, then approved formal entry | Names/phone instead of internal IDs; role choices and errors | UTF-8 Sep 24: real teacher/new, student/new and family/existing submission, actual Electron review and same-ticket formal entry passed on miniapp 8.8.25/cloud 8.11.22. Native approval/rejection cancel preserved pending state. Final student run additionally rejected, edited the name, submitted a new attempt and approved it; exact fixture cleanup and auth/cache restoration passed. Reviewer copy/internal IDs corrected in published desktop 8.9.9; complete device-page live reads, history pagination and refresh passed. Full packaged administrator and ordinary-teacher menu/device refresh/cold-process recovery now pass with controlled verified-account fixtures; ordinary teacher has no review/admin-switch UI, and settled screenshots were inspected. Rejected/editable, corrected/submitted, approved and formal-home screenshots inspected. See desktop-role-review-2026-09-24.md and role-application-approval-continuity-2026-09-24.md. Remaining: password/phone-consent cold auth, miniapp formal-role visual denial, native picker/keyboard and documented desktop account/device-name findings |
