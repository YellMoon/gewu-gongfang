...
| index/index | A/T/S/F/V | Only real authorized entries; navigation and empty state | 8.8.21 fixes formal-role tab navigation; five roles, 25 actual card/shortcut targets and return passed, ten top/bottom screenshots inspected, S/F/V financial boundary verified; see miniapp-home-navigation-verification-2026-09-23.md. Logout touch size/session races, full failure/cold-auth and native confirmation remain |
