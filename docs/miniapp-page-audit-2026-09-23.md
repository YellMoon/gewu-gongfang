...
| account-application/index | V, then approved formal entry | Names/phone instead of internal IDs; role choices and errors | UTF-8 Sep 24: real teacher/new, student/new and family/existing form submission, desktop review HTTP, same-session approval read and Enter Home into the corresponding formal scope passed on 8.8.25/cloud 8.11.22; all 12 successful screenshots inspected, exact cloud/device fixture cleanup and auth/cache restoration verified. Additional student/family runs passed actual isolated Electron main/preload/runtime/review-component modal clicks; approval cancel kept pending and confirm enabled same-ticket formal entry. Family also checked reject-dialog cancel. All seven final family cross-end screenshots inspected. Family binding checked against the isolated student's guardian contact. See role-application-approval-continuity-2026-09-24.md. Remaining: full desktop navigation, reviewer wording/internal-ID prominence, actual rejection/retry, cold auth, formal-role visual denial and native picker/keyboard |
