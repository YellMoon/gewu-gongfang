...
Status: source verified; unified 7.2.11 publication in progress
...
- Automatic release classification selected a patch update, and the unified source version was advanced exactly once from 7.2.10 to 7.2.11. Real WeChat upload, server deployment, desktop/host OSS publication and final matrix evidence are not yet claimed by this checkpoint.
