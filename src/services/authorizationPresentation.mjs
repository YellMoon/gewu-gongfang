...
function bindingPresentation(user) {
  if (['TEACHER_PHONE_NOT_UNIQUE', 'DUPLICATE_TEACHER_PHONE'].includes(user.binding_error)) return { bindingState: 'duplicate-teacher-phone', teacherBindingLabel: '\u624b\u673a\u53f7\u5339\u914d\u5230\u591a\u4e2a\u6559\u5e08' };
  if (user.binding_error === 'TEACHER_NOT_FOUND') return { bindingState: 'teacher-not-found', teacherBindingLabel: '\u672a\u627e\u5230\u5339\u914d\u6559\u5e08' };
...
export function authorizationErrorText(code) {
  const messages = {
    ...
    TEACHER_PHONE_NOT_UNIQUE: '\u8be5\u624b\u673a\u53f7\u5339\u914d\u5230\u591a\u4e2a\u6559\u5e08\uff0c\u8bf7\u5148\u6e05\u7406\u91cd\u590d\u6570\u636e',
