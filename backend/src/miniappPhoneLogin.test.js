...
(async () => {
  ...
  getInstance().db.prepare(`INSERT INTO users
    ...
    VALUES ('manual-known-http', 'openid-known-admin', '13800138005', '13800138005', 'Manual Known HTTP',
  ...
  try {
    ...
    const visitor = await postJson(baseUrl, { code: 'login-code-visitor', phone: '13600136000', miniappVersion: '7.0.1', platform: 'wechat' });
